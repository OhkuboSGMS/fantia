...
某氏の画像がzipで纏めてられなかったのでそれを取得する必要があるかなと思ったんですけど。あとで見たらzipで纏められていたんでダメですね

取得できる画像はpost/XXXのページで複数枚画像が表示されるページです
...
choromedriver
[インストール]("https://qiita.com/pyonkichi/items/da86d1ce919d458a8d8d")
